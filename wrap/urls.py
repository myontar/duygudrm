...
urlpatterns = patterns('',
    ...
    (r'^login$', 'duygudrm.wrap.views.index'),
    (r'^OAuthResponseHandler$', 'duygudrm.wrap.views.oauth_response_handler'),
    (r'^connect$', 'duygudrm.wrap.views.connect'),
    (r'^connected$', 'duygudrm.wrap.views.connected'),
    (r'^accessconnect$', 'duygudrm.wrap.views.accessconnect'),
